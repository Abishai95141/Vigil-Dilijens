...
- [ ] **02 M2-author** (governance/human, doc 12): author the 38 phenomenon spans + traversal edges, threshold rules, data_type normalization — the gap report is the queue.
