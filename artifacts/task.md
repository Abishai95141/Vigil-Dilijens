...
- [ ] **05 M5** Replay interface — recorded readings replay byte-identically  ⟵ **the one remaining Phase-0b exit blocker** (needs qss warm tier: on-disk 2h segments + 7d retention + replay bundle; `cmd/replay` is still a stub)
