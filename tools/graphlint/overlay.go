...
type ovCheck struct {
	...
	Rule     string `yaml:"rule"` // optional same-metric bar discriminator (runtime: MemberCheck.Rule)
}
...
var (
	...
	ovScopeVocab     = map[string]bool{"Container": true, "Pod": true, "Node": true, "PVC": true, "PDB": true, "Workload": true}
